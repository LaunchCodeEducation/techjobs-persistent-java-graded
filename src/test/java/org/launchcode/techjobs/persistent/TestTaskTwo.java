...
//    }
    ...
    * */
    ...
    public void testSqlQuery() throws IOException {
        ...
        Pattern queryPattern = Pattern.compile("SELECT\\s+name\\s+FROM\\s+(techjobs\\.)?employer\\s+WHERE\\s+location\\s*=\\s*[\"\']St.\\s+Louis\\s+City[\"\'];", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE);
